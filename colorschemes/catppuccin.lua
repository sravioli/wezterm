...
function M.apply_to_config(c, opts)
  ...
  if c.color_schemes == nil then c.color_schemes = {} end
  ...
  if c.window_frame == nil then c.window_frame = {} end
  c.window_frame = tableMerge(c.window_frame, window_frame)
end

-- return M
return {
  mocha = M.select(colors, "mocha", "mauve"),
  latte = M.select(colors, "latte", "mauve"),
