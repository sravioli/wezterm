...
---@class Tbl.MergeOpts
---@field behavior? "error"|"keep"|"force" Decides what to do if a key exists in multiple tables:
...
---@field combine? boolean If `true`, list values are concatenated into the base list without duplicates
